...
from musicMoodLifter import models
...
class MLRegistry:
    ...
    def add_algorithm(self, endpoint_name, algorithm_object, algorithm_name,
        ...
        # get endpoint
        endpoint, _ = models.Endpoint.objects.get_or_create(name=endpoint_name, owner=owner)

        # get algorithm
        database_object, algorithm_created = models.MLAlgorithm.objects.get_or_create(
            name=algorithm_name,
        ...
        if algorithm_created:
            status = models.MLAlgorithmStatus(status=algorithm_status,
                                              created_by=owner,
